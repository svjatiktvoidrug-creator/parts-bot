...
IPHONE_PARTS = {
    ...
    "iphone_12_mini": [
        ...
        ("Акумулятор з шлейфом", "787787"), ("Акумулятор з прив'язкою", "859004"),
    ...
    "iphone_12": [
        ...
        ("Акумулятор з прив'язкою", "859005"), ("Акумулятор банка", "820649"),
    ],
    "iphone_12_pro": [
        ("Вібро", "817424"), ("Слуховий динамік", "790630"),
        ("Шлейф слухового динаміка + датчик наближення", "815310"),
    ...
    "iphone_12_pro_max": [
        ...
        ("Акумулятор з прив'язкою", "859007"), ("Акумулятор банка", "820650"),
    ],
    "iphone_13_mini": [
        ...
        ("Акумулятор з шлейфом", "797702"), ("Акумулятор з прив'язкою", "859008"),
    ...
    "iphone_13": [
        ...
        ("Акумулятор з шлейфом", "793515"), ("Акумулятор з прив'язкою", "859009"),
    ...
    "iphone_13_pro": [
        ...
        ("Акумулятор з шлейфом", "793209"), ("Акумулятор з прив'язкою", "859010"),
    ...
    "iphone_13_pro_max": [
        ...
        ("Акумулятор з шлейфом", "793208"), ("Акумулятор з прив'язкою", "859011"),
    ...
    "iphone_14": [
        ...
        ("Акумулятор з шлейфом", "801740"), ("Акумулятор з прив'язкою", "859012"),
    ...
    "iphone_14_plus": [
        ...
        ("Акумулятор з шлейфом", "801741"), ("Акумулятор з прив'язкою", "859013"),
    ...
    "iphone_14_pro": [
        ...
        ("Акумулятор з прив'язкою", "859021"), ("Акумулятор банка", "820715"),
    ],
    "iphone_14_pro_max": [
        ...
        ("Акумулятор з шлейфом", "801743"), ("Акумулятор з прив'язкою", "859022"),
    ...
    "iphone_15": [
        ...
        ("Акумулятор з прив'язкою", "858919"), ("Акумулятор банка", "820717"),
        ("Задня кришка", "817579"),
    ],
    "iphone_15_plus": [
        ...
        ("Акумулятор з шлейфом", "817865"), ("Акумулятор з прив'язкою", "859131"),
    ...
    "iphone_15_pro": [
        ...
        ("Акумулятор з шлейфом", "817894"), ("Акумулятор з прив'язкою", "859132"),
    ...
    "iphone_15_pro_max": [
        ...
        ("Акумулятор з шлейфом", "817922"), ("Акумулятор з прив'язкою", "859133"),
    ...
    "iphone_16": [
        ...
        ("Акумулятор з шлейфом", "852396"), ("Акумулятор з прив'язкою", "880336"),
    ...
    "iphone_16_pro": [
        ...
        ("Акумулятор з шлейфом", "838523"), ("Акумулятор з прив'язкою", "868408"),
        ("Задня кришка", "838521"),
    ],
    "iphone_16_pro_max": [
        ...
        ("Акумулятор з шлейфом", "838531"), ("Акумулятор з прив'язкою", "868406"),
...
def get_main_menu():
    return ReplyKeyboardMarkup([
        ...
        [KeyboardButton("🔄 Відв'язка запчастини")],
...
async def unbind_photo(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("Яку запчастину потрібно відв'язати? Напишіть текстом:")
...
async def unbind_part_remove(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await update.message.reply_text("Яку запчастину потрібно прив'язати? Напишіть текстом:")
...
async def unbind_part_add(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    data = context.user_data
    group_message = (
        "ЗАПИТ НА ВІДВ'ЯЗКУ ЗАПЧАСТИНИ

"
        f"Працівник: {data.get('employee_name', '')}
"
        f"Відв'язати: {data.get('unbind_remove', '')}
"
        f"Прив'язати: {data.get('unbind_add', '')}"
    )
    try:
        user_id = update.effective_user.id
        unbind_keyboard = InlineKeyboardMarkup([
            [InlineKeyboardButton("🔄 Відв'язати запчастину", callback_data=f"unbind_done_{user_id}")]
        ])
        await context.bot.send_photo(
            chat_id=GROUP_CHAT_ID,
            message_thread_id=ORDER_THREAD_ID if ORDER_THREAD_ID else None,
...
async def unbind_done(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    await context.bot.send_message(
        ...
        text=f"Введіть номер переміщення для відповіді працівнику (reply на це повідомлення):
worker_id:{user_id}"
    )
...
def main():
    ...
    unbind_conv = ConversationHandler(
        entry_points=[MessageHandler(filters.TEXT & filters.Regex("Відв'язка запчастини"), unbind_start)],
        states={
