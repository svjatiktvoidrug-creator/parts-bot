...
async def choose_iphone_model(update: Update, context: ContextTypes.DEFAULT_TYPE):
    ...
    if model_key == "iphone_custom":
        await query.edit_message_text("Введіть модель iPhone та запчастину яка потрібна:")
...
def main():
    ...
    order_conv = ConversationHandler(
        ...
        states={
            ...
            CUSTOM_MODEL_TEXT: [MessageHandler(filters.TEXT & ~filters.COMMAND, custom_model_text)],
